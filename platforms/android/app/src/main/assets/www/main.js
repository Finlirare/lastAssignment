...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes, { preloadingStrategy: _angular_router__WEBPACK_IMPORTED_MODULE_2__["PreloadAllModules"] }), _login_login_module__WEBPACK_IMPORTED_MODULE_3__["LoginPageModule"]
            ],
...
/* harmony import */ var _popover_settings_popover_settings_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./popover-settings/popover-settings.component */ "./src/app/popover-settings/popover-settings.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"], _popover_settings_popover_settings_component__WEBPACK_IMPORTED_MODULE_16__["PopoverSettingsComponent"]],
            entryComponents: [_popover_settings_popover_settings_component__WEBPACK_IMPORTED_MODULE_16__["PopoverSettingsComponent"]],
            schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_ELEMENTS_SCHEMA"]],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
                ng_socket_io__WEBPACK_IMPORTED_MODULE_7__["SocketIoModule"].forRoot(config),
                ...
                _ionic_storage__WEBPACK_IMPORTED_MODULE_12__["IonicStorageModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"],
                ...
                _agm_core__WEBPACK_IMPORTED_MODULE_10__["AgmCoreModule"].forRoot({ apiKey: 'AIzaSyCf5imGc4PIY7TyUWgsjHPH-lXhcgZbQ1o' })
            ],
            providers: [
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        var userAuthenticated = false; // Get the current authentication state from a Service!
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Log in to continue</ion-title>\n    \n  </ion-toolbar>\n</ion-header>\n<ion-content padding>\n    <ion-col>\n        <ion-row>\n          <div *ngIf=\"(user | async) || {} as user\">\n              <ion-button *ngIf=\"!user.uid\" (click)=\"login()\">Login with Google</ion-button>\n              <div *ngIf=\"user.uid\">\n                  Welcome {{user.displayName}}\n                  <!--{{user.uid}}!-->\n              </div>\n          </div>\n        </ion-row>\n     </ion-col>\n</ion-content>"
...
var LoginPage = /** @class */ (function () {
    function LoginPage(loginService) {
...
/***/ "./src/app/popover-settings/popover-settings.component.html":
/*!******************************************************************!*\
  !*** ./src/app/popover-settings/popover-settings.component.html ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "<ion-button (click)=\"logout()\">Logout</ion-button>"

/***/ }),

/***/ "./src/app/popover-settings/popover-settings.component.scss":
/*!******************************************************************!*\
  !*** ./src/app/popover-settings/popover-settings.component.scss ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BvcG92ZXItc2V0dGluZ3MvcG9wb3Zlci1zZXR0aW5ncy5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/popover-settings/popover-settings.component.ts":
/*!****************************************************************!*\
  !*** ./src/app/popover-settings/popover-settings.component.ts ***!
  \****************************************************************/
/*! exports provided: PopoverSettingsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopoverSettingsComponent", function() { return PopoverSettingsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_login_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/login.service */ "./src/app/services/login.service.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var PopoverSettingsComponent = /** @class */ (function () {
    function PopoverSettingsComponent(loginService, popoverController) {
        this.loginService = loginService;
        this.popoverController = popoverController;
    }
    PopoverSettingsComponent.prototype.ngOnInit = function () {
    };
    PopoverSettingsComponent.prototype.logout = function () {
        this.popoverController.dismiss();
        this.loginService.signOut();
    };
    PopoverSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-popover-settings',
            template: __webpack_require__(/*! ./popover-settings.component.html */ "./src/app/popover-settings/popover-settings.component.html"),
            styles: [__webpack_require__(/*! ./popover-settings.component.scss */ "./src/app/popover-settings/popover-settings.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["PopoverController"]])
    ], PopoverSettingsComponent);
    return PopoverSettingsComponent;
}());
...
var LoginService = /** @class */ (function () {
    function LoginService(loadingController, afAuth, gplus, platform, alertController, navCtrl, storage, router, socket) {
    ...
    LoginService.prototype.login = function () {
        if (!this.platform.is('cordova')) {
            this.nativeGoogleLogin().then(function (as) {
                // this.router.navigate(['/tabs/tab1']);
    ...
    LoginService.prototype.nativeGoogleLogin = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        }).then(function (user) { return console.log(user); }, function (error) { return console.error('Error storing item', error); });
                        return [4 /*yield*/, this.afAuth.auth.signInWithCredential(firebase_app__WEBPACK_IMPORTED_MODULE_7__["auth"].GoogleAuthProvider.credential(gplusUser.idToken)).then(function () {
    ...
    LoginService.prototype.webGoogleLogin = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    LoginService.prototype.signOut = function () {
        ...
        this.afAuth.auth.signOut().then(function () {
            _this.storage.remove('google_user');
...
module.exports = __webpack_require__(/*! C:\Users\carol\Documents\GitHub\lastAssig\src\main.ts */"./src/main.ts");
