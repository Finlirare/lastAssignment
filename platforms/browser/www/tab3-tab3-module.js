...
var FilesystemPluginWeb = /** @class */ (function (_super) {
    ...
    FilesystemPluginWeb.prototype.writeFile = function (options) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var path, data, parentPath, parentEntry, parentArgPath, now, pathObj;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = this.getPath(options.directory, options.path);
...
var LocationService = /** @class */ (function () {
    ...
    LocationService.prototype.getCurrentPosition = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                isAvailable = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Capacitor"].isPluginAvailable('Geolocation');
                if (!isAvailable) {
                    console.log('err');
                    return [2 /*return*/, Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(new Error('Err'))];
                }
                POSITION = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Geolocation.getCurrentPosition()
                    //Catching capacitor error
                    .catch(function (err) {
                    console.log('error', err);
                    return new Error(err.message || 'customized message');
                });
                this.coordinates$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(POSITION).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (data) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(data.coords); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log(data); }));
...
module.exports = "<ion-header>\r\n  <ion-toolbar>\r\n    <ion-title>\r\n     Camera\r\n    </ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n<ion-content>\r\n  <img [src]=\"this.image\" *ngIf=\"this.image\"/>\r\n  <ion-button (click)=\"saveImage()\">Save image</ion-button>\r\n\t<ion-button (click)=\"takePhoto()\">New photo</ion-button>\r\n</ion-content>\r\n"
...
module.exports = "* {\n  text-align: center; }\n\nimg {\n  display: block;\n  margin: 0 auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(socket, locationService) {
        this.socket = socket;
        this.locationService = locationService;
    }
    //Using capacitor to take a photo
    Tab3Page.prototype.takePhoto = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var result;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    Tab3Page.prototype.saveImage = function () {
        var _this = this;
        this.locationService.getCurrentPosition().then(function (result) {
            console.log(result);
            console.log(result.coords.longitude);
            console.log(result.coords.latitude);
            _this.savedImg = _this.image;
            var img = { long: result.coords.longitude, lat: result.coords.latitude, image: _this.savedImg };
            console.log(_this.savedImg);
            _this.socket.emit('image', img);
        });
    };
    ...
    Tab3Page = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ng_socket_io__WEBPACK_IMPORTED_MODULE_3__["Socket"], _services_location_service__WEBPACK_IMPORTED_MODULE_4__["LocationService"]])
    ], Tab3Page);
    return Tab3Page;
}());
